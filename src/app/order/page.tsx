...
//           },
//         ],
//         subtotal: Number(form.price) * Number(form.quantity),
//         tax: 0,
//         shipping: 0,
...
export default function OrderPage() {
  ...
  const handleFileUpload = async (file: File, folder: string, fileType: string) => {
    const formData = new FormData();
  ...
  const handleImageChange = async (index: number, file: File | null) => {
    if (!file) return;
    const url = await handleFileUpload(file, "fetchkids/orders/photos", "photo");
    const updated = [...products];
                ...
                <div className="border-t pt-3 mt-3">
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleCustomizationChange(index, "color", e.target.value)
                      }
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleCustomizationChange(index, "style", e.target.value)
                      }
                      className="border p-2 rounded flex-1"
                    />
                  </div>
